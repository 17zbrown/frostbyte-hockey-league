...
CG.adminShell = function(section, inner){
  ...
  var notice = CG.LIVE_MODE
    ? '<div class="note chr" style="margin-bottom:18px;display:flex;gap:10px;align-items:flex-start">'+CG.ic("clock",15)+'<span><b style="font-family:var(--f-disp)">Pre-season Central is fully live</b> — registrations, roster signings, owner apps, and scouting all write to the database. Still being connected: results entry, discipline, draft-pick making, and trades — for those right now, use the <a href="/legacy.html" style="font-weight:700;border-bottom:2px solid var(--chrome)">classic admin</a>.</span></div>'
    : "";
