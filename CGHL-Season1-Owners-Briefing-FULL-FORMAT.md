# CGHL Owners' Briefing — FULL FORMAT (on the shelf)

> This is the briefing for the league's FULL season format — pre-season, free-agency week, 14 linear rounds, 17-man rosters, multi-season contracts. It is NOT the current format. Season 1 runs the BASIC format; the current briefing is CGHL-Season1-Owners-Briefing.md. Kept so the full model can be reinstated without rewriting it (Rulebook Appendix A). The Season 1 dates below are the full-format calendar as it stood before the switch on Sept 15, 2026.
