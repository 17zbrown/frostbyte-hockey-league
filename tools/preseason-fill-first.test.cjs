...
A("[basic] Rule 0.4 says there is no pre-season", /There is no pre-season in the basic format/.test(sec("0.4")));
A("[basic] Rule 2.1 gives depth placements the equivalent no-limit carve-out", /Depth placements are the one exception to the roster shape/.test(sec("2.1")) && /he counts against neither the nine-six-three shape nor any roster cap, so every registered player has a club/.test(sec("2.1")));
