...
**What a pick costs.** Draft salaries are set by round, not negotiated: the last round pays the $750,000 league minimum and every round above it adds $250,000 (so with 12 rounds, round 1 is $3,500,000 and a full class is $25,500,000, $27.5M of the $50M cap with your AGM at $2M). The scale follows whatever round count is published, and the draft room shows it. Every pick in a round costs the same, and the same scale applies if your clock expires and the league picks off your board.
